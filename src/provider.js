...
let web3, contract, contractToken, onChangeAccount, account, getIpfs, isMetaMaskAvail = false

//if (window.web3) {
if (window.web3) {
  isMetaMaskAvail = true
  web3 = new window.Web3(window.web3.currentProvider)
} else {
  web3 = new window.Web3(new window.Web3.providers.HttpProvider(`https://${network === 'main' ? 'mainnet' : 'rinkeby'}.infura.io/8pRTWGvu6RdXVYyLnOqv`))
}
